import styles from "./PatientClients.module.css";

const PatientClients = ({ patients }) => {
  return (
    <div>
            ...
            <div className={styles.patientContainer}>
              <div key={patient.id}>
                ...
                <div className={styles.buttonWrapper}>
                  <button className={styles.activeButton}>Detalji</button>
                </div>
              </div>
            </div>
          );
